...
;;; gui-fonts
(when window-system
  (set-fontset-font "fontset-default" '(#x1100 . #xffdc)  '("UnGraphic" . "unicode-bmp"))
  (set-fontset-font "fontset-default" '(#xe0bc . #xf66e)  '("UnGraphic" . "unicode-bmp")))



(load-file "~/local/slime-clisp.el")
