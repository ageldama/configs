...
(defun def-hydras ()
  ...
  (eval `(defhydra hydra-org (:exit t)
           ("a" org-agenda "org-agenda")
           ,@(when (fboundp 'consult-org-agenda)
               '(("C-a" consult-org-agenda "consult-org-agenda")))
  ...
  (eval
   `(defhydra hydra-mini
      ...
      ,@(cond
         ;; NOTE [2025-10-05 Sun 16:32] disable since it somehow hangs
         ;; ((and (fboundp 'projectile-mode) (fboundp 'counsel-projectile))
