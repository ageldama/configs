...
if 1
  ...
  if has('gui_running')
    ...
    "set guifont=M\+CodeLat60\ Nerd\ Font\ Mono\ 10
...
map <leader>cp :call ProjSetCwd()<cr>
...
function! ProjSetCwd()
	...
	endfo
  echo printf("PWD: %s", fnameescape(wd == '' ? cph : substitute(wd, mkr.'$', '.', '')))
