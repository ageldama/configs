...
-- FIXME: screen.connect_signal("property::geometry", set_wallpaper)

awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    -- FIXME: set_wallpaper(s)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "F9", function () awful.spawn('xscreensaver-toggle.pl') end,
              {description = "toggle xscreensaver daemon", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "p", function () awful.spawn('gnome-screenshot -i') end,
              {description = "screenshot -i", group = "launcher"}),
